...
> **Python note:** The code below uses `import`, `class`, `for` loops, and `print`. If any of that is unfamiliar, the [Python for AI notebook](https://colab.research.google.com/github/sunilmogadati/ai-engineer-accelerator/blob/main/AI_Engineer_Accelerator_Python_for_AI.ipynb) covers everything you need. But try running the code first — you may understand more than you think.
...
1. **Run the code** in the [Deep Learning notebook](https://colab.research.google.com/github/sunilmogadati/ai-engineer-accelerator/blob/main/AI_Engineer_Accelerator_Deep_Learning_PyTorch.ipynb) — Sections 3-4 walk you through this exact example with visualizations
